...
const MoviesList = props => {
    ...
    const [currentSearchMode, setCurrentSearchMode] = useState("") //new state variable, has findbytitle or rating
    ...
    const retrieveNextPage = () => { // whenever currentSearch changes, reset currentPage to zero, its a new search
